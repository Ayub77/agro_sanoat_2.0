                                ...
                                ? Column(
                                    children: [
                                      Container(
                                          ...
                                          height: 380,
                                          child: PageView(
                                            controller: provider.newsController,
                                            children: [
                                              for (int i = 0;
                                                  i < provider.itemNews.length;
                                                  i++)
                                                ScrollNewsWidget(
                                                  size: size,
                                                  item: provider.itemNews[i],
                                                  ontap: () {
                                                    provider.ontapNews(context,
                                                        provider.itemNews[i]);
                                                  },
                                                ),
                                            ],
                                            onPageChanged: (index) {
                                              provider.changeNews(index);
                                            },
                                          )),
                                      Row(
                                        mainAxisAlignment:
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: PageView(
                                          ...
                                          children: [
                                            for (int i = 0;
                                                i < provider.itemInfo.length;
                                                i++)
                                              ScrollInfoWidget(
                                                item: provider.itemInfo[i],
                                                size: size,
                                                ontap: () {
                                                  provider.ontapInfo(context,
                                                      provider.itemInfo[i]);
                                                },
                                              ),
                                          ],
                                          onPageChanged: (index) {
                                            provider.changeInfo(index);
                                          },
                                        ),
                                      ),
                                      Row(
